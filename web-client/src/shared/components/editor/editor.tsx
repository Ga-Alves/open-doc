...
export default function Editor({ isEditable, initialContent }: EditorProps) {
  ...
  useEffect(() => {
    ...
    const provider = new WebrtcProvider("your-room-name-wasd", ydoc, {
      password: "optional-room-password",
      signaling: ["http://localhost:4444"],
    });

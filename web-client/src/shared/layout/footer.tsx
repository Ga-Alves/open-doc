...
function SocialLink({
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-2 text-xs font-medium text-gray-500 hover:text-gray-900 transition-colors duration-200"
      {...props}
    >
      {children}
    </a>
      ...
      <div className="max-w-4xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
        <div className="space-y-1">
          ...
          <p className="text-xs text-gray-400">
            Built by Gabriel Alves.
          </p>
        </div>

        <div className="flex items-center gap-5">
          <SocialLink href="https://github.com/Ga-Alves/open-doc">
            <svg
          ...
          <SocialLink href="https://www.linkedin.com/in/gabriel-alves-71552822b">
            <svg
              className="w-4 h-4 fill-current"
              viewBox="0 0 24 24"
              aria-hidden="true"
